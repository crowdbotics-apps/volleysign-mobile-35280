...
## Project Structure
    ...
    ├── volleysign_mobile_35280  # Django project configurations
...
1. Clone this repo and `cd volleysign_mobile_35280`
...
2. Clone this repo and `cd volleysign_mobile_35280`
